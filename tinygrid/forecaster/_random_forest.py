...
class RandomForestForecaster(_BaseForecaster):
  def __init__(self, verbose=0, profile="default"):
    ...
    self.cutoffs = { 
      'Building0' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),
      'Building1' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Building3' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Building4' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Building5' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Building6' : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Solar0'    : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Solar1'    : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Solar2'    : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Solar3'    : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0),  
      'Solar4'    : None,
      'Solar5'    : datetime.datetime(day=1, month=1,  year=2020, hour=0, minute=0, second=0)}
