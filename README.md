...
## Usage
This website must be opened with Google Chrome on a Unix/Linux machine with a minimum screen size of 13". This is due to the restrictiveness of packages, fronts & design. Here is a link to the [TinyGrid Dashboard](hbhungg.github.io/tinygrid/website).
